...
<title>Payment-in-lieu-of-tax (PILOT) Contributions | City of Boston</title>
<!-- TemplateEndEditable -->
...
<div class="sub_main_hd">
                   ...
                   <div class="content">
                   <h2>Payment-in-Lieu-of-Tax (PILOT) Contributions</h2>
...
<div class="content_main_sub">
                      <p>The City began collecting payment-in-lieu-of-tax (PILOT) contributions from tax-exempt institutions many years ago in an attempt to relieve the strain on residential and commercial taxpayers by diversifying the City's revenue stream. The contributing institutions provide the City with funds to help offset a portion of the cost of providing them with essential City services (i.e. police protection, fire protection, snow removal, etc). Today, institutions continue to make annual PILOT payments according to provisions in their agreement(s) with the City.</p><p>The following reports are available in Adobe.PDF format:</p><p><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-46674", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Fiscal Year 2011 PILOT Contributions</a></p><p><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-21694", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Fiscal Year 2010 PILOT Contributions</a></p><p><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-17267", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Fiscal Year 2009 PILOT Contributions</a></p><p><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-17266", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Fiscal Year 2008 PILOT Contributions</a></p><p><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-17265", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Fiscal Year 2007 PILOT Contributions</a></p>
</div>
...
<ul>
                                                                        ...
                                                                        <li><a href="/assessing/PILOT.asp">PILOT (Payment in Lieu of Taxes) Task Force</a></li>
