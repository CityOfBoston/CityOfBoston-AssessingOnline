...
<title>Tax Deferral for Elderly (age 65+) | City of Boston</title>
<!-- TemplateEndEditable -->
...
<div class="sub_main_hd">
                  ...
                  <div class="image_wrap1"><div class="image_wrap2">
                         <img src="/images_documents/elder_flowers_tcm3-13166.jpg"  alt="Senior Gardener (150)" >
                  </div></div>

	  <div class="content float_150">
                  <h2>Tax Deferral for Elderly </h2>
                  
                              <p>Are you 65 or older and having trouble paying your property tax bills? There's a way to defer your taxes and remain in your home. The Tax Deferral program may be considered when a taxpayer's current expenses make the continued ownership of their home difficult. A 4% interest charge is applied to the deferred taxes.</p>
...
<input type="hidden" name="site" value="All_Cityofboston"/>
	...
	<h2 class="header">Related Links/Deferral</h2>
...
<ul>
                                                                        ...
                                                                        <li><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-29887", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" tridion:href="tcm:3-29887" tridion:type="Multimedia" tridion:targetattribute="href" tridion:href="tcm:3-29887" tridion:type="Multimedia" tridion:targetattribute="href">Massachusetts Department of Revenue Taxpayer Guide to Tax Deferral 41A</a></li>
