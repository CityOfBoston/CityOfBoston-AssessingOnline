...
<title>Circuit Breaker Income Tax Credit | City of Boston</title>
<!-- TemplateEndEditable -->
     <meta name="keywords" content="" />
     <meta name="description" content="Circuit Breaker Income Tax Credit"/>
...
<div class="sub_main_hd">
                   ...
                   <div class="content">
                   <h2>Circuit Breaker Income Tax Credit</h2>
                   
                               <p>For Persons Age 65 and Older Low to Moderate-Income Seniors</p>
...
<div class="content_main_sub">
                      <p>The Circuit Breaker Income Tax Credit provides tax relief for moderate and low to moderate-income senior citizens. Qualifying senior citizens may claim a credit in their state income tax returns for the real estate taxes paid on their Boston residential property, effective for the tax years beginning on or after January 1, 2001.</p><p style="TEXT-ALIGN: center"><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-8911", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" >Circuit Breaker Income Tax Credit</a></p><p style="TEXT-ALIGN: center">For more information on eligibility requirements contact:</p><p style="TEXT-ALIGN: center">Massachusetts Department of Revenue
<br />
Customer Service Bureau
<br />
617-887-MDOR (6367) 
<br /><a href="http://www.mass.gov/dor/" target="_blank" class="_external" >http://www.mass.gov/dor/</a></p>
</div>
...
<ul>
                                                                        ...
                                                                        <li><a href="http://www.mass.gov/dor/individuals/filing-and-payment-information/guide-to-personal-income-tax/credits/real-estate-tax-credit.html" target="_blank" class="_external">Massachusetts Income Tax Credit - 'Circuit Breaker' for Persons Age 65+</a></li>
                                                                

                                                                

          				
                                                                        <li><a href="https://wfb.dor.state.ma.us/income/Default.aspx" target="_blank" class="_external">Webfile for Income</a></li>
