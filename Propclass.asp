...
<title>Property Classification | City of Boston</title>
<!-- TemplateEndEditable -->
...
Includes any property involved in manufacturing, processing or extraction. It includes utility real property used for storage and generation. Not all parcels of real property fall into the four classes. Some property has mixed residential/commercial use.</dd></dl></dd></dl></div>
...
<ul>
                                                                        ...
                                                                        <li><a href="<%= Server.CreateObject("cd_link.BinaryLink").GetLink("tcm:0-3-1", "tcm:3-16189", "AA", "BB", "CC", true).URL %>" class="pdf" target="_blank" tridion:href="tcm:3-16189" tridion:type="Multimedia" tridion:targetattribute="href" tridion:href="tcm:3-16189" tridion:type="Multimedia" tridion:targetattribute="href">Massachusetts Classification Occupancy Codes</a></li>
