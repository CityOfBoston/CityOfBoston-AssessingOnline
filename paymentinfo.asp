...
dim ymd,d,m,y,wyr,stramt,tbilled
	...
	m = month(now)
	y = year(now)
	' hardcode for Jan 2017 because of iNovah
	m = 1
	y = 2017
if m > 6 then y=y+1
...
Assessingpay.connectiontimeout = session("Assessingsearch_connectiontimeout")
Assessingpay.commandtimeout = session("Assessingsearch_commandtimeout")
Assessingpay.open session("Assessingsearch_connectionstring"), session("Assessingsearch_runtimeusername"), session("Assessingsearch_runtimepassword")
...
<div>
 ...
 <%    
	...
	'hardcode for FY2017 because inovah
	firstYr = 2017
...
<center>
<div class="mainColTableHeaderRowBorders">Tax Bill and Payment Information as of January 1, 2017</div>
...
<%
Else
	' for data in Inovah, refer to invoicecloud
	Response.Write "<tr><td colspan='3' align='center'><br>To view current information about bills and payments dated after <strong>December 31, 2016</strong> visit the <a href='https://payments.cityofboston.gov/'>InvoiceCloud payment portal</a><br><br></td></tr>"
End If
%>
