...
If Left(Request.ServerVariables("HTTP_X_FORWARDED_FOR"),11) <> "140.241.241" Then
	Response.End
End If
...
AbatementExemptionStartThisYear = CDate("2020-01-01 00:01")
AbatementExemptionStartNextYear = CDate("2021-01-01 00:01")

' abatementdeadlines are Feb-01, or Feb-02 or Feb-03 if not a weekday
AbatementDeadlineThisYear = CDate("2020-02-03 17:00")

' national guard deadline is 3 months after bills are mailed
NationalGuardDeadlineThisYear = CDate("2020-06-01 17:00")

' exemptiondeadlines are Apr-01, or Apr-02 or Apr-03 if not a weekday
ExemptionDeadlineThisYear = CDate("2020-06-01 17:00")

' Business Improvement District due dates, update as needed
BIDDueDateQ1 =  "August 1, 2019"
BIDDueDateQ2 =  "November 1, 2019"
BIDDueDateQ3 =  "February 3, 2020"
BIDDueDateQ4 =  "May 1, 2020"

' public disclosure is in November every three-ish years (2012, 2015, 2020)
PublicDisclosureStartAnnouncing = CDate("2020-11-10 00:01")
PublicDisclosureStartOfficial =  CDate("2020-11-16 00:01")
PublicDisclosureStartOnWeb =  CDate("2020-11-14 00:01")
PublicDisclosureEnd = CDate("2020-11-24 17:01")
...
Function MapLinkFunction( parcel_id )
	...
	MapLinkFunction = "<a class=""mainColLink"" href=""http://app01.cityofboston.gov/ParcelViewer/?pid=" & parcel_id & """ onclick=""var PopupWin=window.open('http://app01.cityofboston.gov/ParcelViewer/?pid=" & parcel_id & "','PopupWin','status=yes,resizable=yes,menubar=yes,toolbar=yes,location=yes,directories=yes,scrollbars=yes'); return false;"">Map</a>"
...
%>
	...
	<tr>
		<td>
			&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.boston.gov/community-preservation-act">Community Preservation</a>:
		</td>
		<td align="right">
...
%>
	...
	<tr class="mainCategoryModuleTextBottom">
		<td align="left"><br>
			<b>FY<%=TaxYear%> Preliminary Tax:</b>
		</td>
	</tr>
...
<%
	...
	If isResidential Then
		...
		If HasResidentialExemption Then
				%><p>A <b>Residential Exemption</b> has already been granted for this parcel.</p><%
		End If
...
<table width="100%">
	<tr class="mainColTableHeaderRowBorders">
		<th colspan=2>Current Owners</th>
	</tr>
<%
...
<center><p>
Owner information may not reflect any changes submitted to City of Boston Assessing after <%=OwnershipLastUpdate%>.  <%=OwnershipChangeAlert%>
</p></center>
<br>
<%
...
Sub ShowCondoAttributes()

Dim sSQL
Dim RecordSetOutbuildings


	sSQL = "SELECT * FROM [condo_attributes] WHERE parcel_id='" & QueryStringPID & "'"
...
<table width="100%">
	...
	<tr>
		...
		<td align="right"><a class="mainColLink" href="?parcel=<%=g_objRecords("condo_main")%>"><%=g_objRecords("condo_main")%></a></td>
	</tr>
	<tr>
		<td><i>Style:</i></td>
		<td align="right"><%=g_objRecords("Style")%></td>
	</tr>
	<tr>
		<td><i>Exterior Condition:</i></td>
		<td align="right"><%=g_objRecords("Exterior Condition")%></td>
	</tr>
	<tr>
		<td><i>Exterior Wall:</i></td>
		<td align="right"><%=g_objRecords("Exterior Wall")%></td>
	</tr>
	<tr>
		<td><i>Grade:</i></td>
		<td align="right"><%=g_objRecords("Grade")%></td>
	</tr>
	<tr>
		<td><i>Stories:</i></td>
		<td align="right"><%=g_objRecords("Stories")%></td>
	</tr>
	<tr>
		<td><i>Number of Units:</i></td>
		<td align="right"><%=g_objRecords("#Units")%></td>
	</tr>
	<tr>
		<td><i>Street Type:</i></td>
		<td align="right"><%=g_objRecords("Street Type")%></td>
	</tr>
	<tr>
		<th align="left" colspan="2" style="border-bottom: 1px solid silver; padding-top: 1em">UNIT ATTRIBUTES</th>
	</tr>
	<tr>
		<td><i>Square Feet of Living Area:</i></td>
		<td align="right"><%=FormatNumber( Ternary( IsNumeric(Trim(g_objRecords("Square Feet of Living area"))), g_objRecords("Square Feet of Living area"), "0" ),0)%></td>
	</tr>
	<tr>
		<td><i>Base Floor:</i></td>
		<td align="right"><%=g_objRecords("Base Floor")%></td>
	</tr>
	<tr>
	...
	<tr>
		<td><i>Number of Floors:</i></td>
		<td align="right"><%=g_objRecords("# Floors")%></td>
	</tr>
	<tr>
		<td><b><i>Total Rooms:</i></b></td>
		<td align="right"><b><%=g_objRecords("Total Rooms")%></b></td>
	</tr>
	<tr>
		<td><i>Bedrooms:</i></td>
	...
	<tr>
		...
		<td align="right"><%=g_objRecords("Half Bathrooms")%></td>
	</tr>
	<tr>
		<td><i>Bath Style 1:</i></td>
		<td align="right"><%=g_objRecords("Bathroom Style1")%></td>
	</tr>
	<tr>
		<td><i>Bath Style 2:</i></td>
		<td align="right"><%=g_objRecords("Bathroom Style2")%></td>
	</tr>
	<tr>
		<td><i>Bath Style 3:</i></td>
		<td align="right"><%=g_objRecords("Bathroom Style3")%></td>
	</tr>
	<tr>
		<td><i>Kitchen Style:</i></td>
		<td align="right"><%=g_objRecords("Kitchen Style")%></td>
	</tr>
	<tr>
		<td><i>Kitchen Type:</i></td>
		<td align="right"><%=g_objRecords("Kitchen Type")%></td>
	</tr>
	<tr>
		<td><i>Heat Type:</i></td>
		<td align="right"><%=g_objRecords("Heat Type")%></td>
	</tr>
	<tr>
		<td><i>Interior Condition:</i></td>
		<td align="right"><%=g_objRecords("Interior Condition")%></td>
	</tr>
	<tr>
		<td><i>Interior Finish:</i></td>
		<td align="right"><%=g_objRecords("Interior Finish")%></td>
	</tr>
	<tr>
		<td><i>Orientation:</i></td>
		<td align="right"><%=g_objRecords("Orientation")%></td>
	</tr>
	<tr>
		<td><i>Corner Unit:</i></td>
		<td align="right"><%=g_objRecords("Corner Unit")%></td>
	</tr>
	<tr>
		<td><i>View:</i></td>
		<td align="right"><%=g_objRecords("View")%></td>
	</tr>
</table>
<%
	...
	Set RecordSetOutbuildings = g_objConn.Execute("SELECT * FROM [outbuilding_attributes] WHERE parcel_id='" & QueryStringPID & "'")
...
%>
	<tr>
		<td><i>Type:</i></td>
		<td align="right"><%=RecordSetOutbuildings("OutBuilding_Type")%></td>
	</tr>
	<tr>
		<td><i>Size/sqft:</i></td>
		<td align="right"><%=RecordSetOutbuildings("Size/Sqft")%></td>
	</tr>
<%
...
Dim RecordSetOutbuildings
	...
	sSQL = "SELECT * FROM [residential_attributes] WHERE parcel_id='" & QueryStringPID & "'"
...
<table width="100%">
	...
	<tr>
		<td><i>Topography:</i></td>
		<td align="right"><%=g_objRecords("Topography")%></td>
	</tr>
	<tr>
		<td><i>Lot Size:</i></td>
		<td align="right"><%=g_objRecords("Lot Size")%></td>
	</tr>
</table>
<%
	BuildingCount = 0
...
<table width="100%">
	...
	<tr>
		<td><i>Overall Condition:</i></td>
		<td align="right"><%=g_objRecords("Overall Condition")%></td>
	</tr>
	<tr>
		<td><i>Stories:</i></td>
		<td align="right"><%=g_objRecords("Stories")%></td>
	...
	<tr>
		<td><i>Bathrooms:</i></td>
		<td align="right"><%=g_objRecords("Bathrooms")%></td>
	</tr>
	<tr>
		<td><i>Half Bathrooms:</i></td>
		<td align="right"><%=g_objRecords("Half Bathrooms")%></td>
	...
	<tr>
		<td><i>Bath Style 1:</i></td>
		<td align="right"><%=g_objRecords("Bath Style 1")%></td>
	</tr>
	<tr>
		<td><i>Bath Style 2:</i></td>
		<td align="right"><%=g_objRecords("Bath Style 2")%></td>
	</tr>
	<tr>
		<td><i>Bath Style 3:</i></td>
		<td align="right"><%=g_objRecords("Bath Style 3")%></td>
	</tr>
	<tr>
	...
	<tr>
		<td><i>Air Conditioning:</i></td>
		<td align="right"><%=g_objRecords("Air Conditioning")%></td>
	</tr>
	<tr>
		<td><i>Interior Condition:</i></td>
		<td align="right"><%=g_objRecords("Interior Condition")%></td>
...
<table width="100%">
	...
	<tr>
		...
		<td align="right"><%=RecordSetTaxbill("condo_units_commercial")%></td>
	</tr>
	<tr>
		<td>Mixed-use units:</td>
		<td align="right"><%=RecordSetTaxbill("condo_units_mixed")%></td>
	</tr>
	<tr>
		<td><a class="mainColLink" href="?parcel=<%=sParcelID%>">Total units:</a></td>
		<td align="right"><%=(RecordSetTaxbill("condo_units_residential") + RecordSetTaxbill("condo_units_commercial") + RecordSetTaxbill("condo_units_mixed"))%></td>
	</tr>
...
'########################################################################
' show contents of the [notices] table for the public disclosure period which happens every three years (2009, 2012, 2015, ...)
Sub ShowPublicDisclosure()

Dim sSQL
Dim RecordSetNotices


	sSQL = "SELECT [FY16_assessed_value],[FY15_billed_value],[FY16_exemptions],[FY15_exemptions],[FY16_gross_tax],[FY15_gross_tax],[FY16_net_tax],[FY15_net_tax] FROM [notices] WHERE parcel_id='" & QueryStringPID & "'"
	
	Set RecordSetNotices = g_objConn.Execute(sSQL)

	If RecordSetNotices.EOF Then
		g_sError = "No Records Found"
		Exit Sub
	End If
%>
...
<table width="80%">
	...
	<tr class="mainColTableHeaderRowBorders">
		<th colspan=3>FY2016 Public Disclosure</th>
	</tr>
	<tr>
		<td colspan=3><br>Disclosed values are subject to review and certification by the Massachusetts Department of Revenue.<br><br></td>
	</tr>
	<tr>
		<td>
		</td>
	...
	<tr>
		...
		<td align="right">
			<%=FormatCurrency(CLng(RecordSetNotices("FY16_assessed_value")))%>
		</td>
		<td align="right">
			<%=FormatCurrency(CLng(RecordSetNotices("FY15_billed_value")))%>
		</td>
	</tr>

	<tr>
		<td align="left">
			<b>Tax Rate</b>:<span style="color: red"><sup>*</sup></span>
		</td>
		<td align="right">
		</td>
		<td align="right">
	...
	<tr>
		<td align="left">
			<b>Gross Tax</b>:<span style="color: red"><sup>*</sup></span>
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY16_gross_tax")) )%>	
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY15_gross_tax")) )%>
		</td>
	</tr>

	<tr>
		<td align="left">
			<b>Exemptions</b>:<span style="color: red"><sup>*</sup></span>
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY16_exemptions")) )%>	
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY15_exemptions")) )%>	
		</td>
	</tr>

	<tr>
		<td align="left">
			<b>Net Tax</b>:<span style="color: red"><sup>*</sup></span>
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY16_net_tax")) )%>	
		</td>
		<td align="right">
			<%=FormatCurrency( CDbl(RecordSetNotices("FY15_net_tax")) )%>	
		</td>
	</tr>

	<tr>
		<td colspan=3><span style="color: red">
			<br><sup>*</sup></span> The Fiscal Year 2016 tax rate, gross tax, and exemption amounts (if any) are ESTIMATED figures.
		</td>
	</tr>
	<tr>
		<td colspan=3>
			<br>The triennial public disclosure period for assessed values runs from <%=FormatDateTime(PublicDisclosureStartOfficial,1)%> to <%=FormatDateTime(PublicDisclosureEnd,1)%>.  Owners may request a review of the disclosed value during this period by using the <a href="/assessing/revaluation/?pid=<%=QueryStringPID%>">Preliminary Assessment Review Request Form</a>.
		</td>
	</tr>
...
<div class="MainHeaderFont">Assessing On-Line</div>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr class="mainCategoryModuleText">
			<td><b>Address:</b></td>
			<td align="right"><%=(RecordSetTaxbill("street_number") & Ternary(Trim(RecordSetTaxbill("street_number_suffix"))="","","-" & Trim(RecordSetTaxbill("street_number_suffix"))) & " " & RecordSetTaxbill("street_name") & Ternary( (Trim(RecordSetTaxbill("apt_unit"))<>"") , " # " & RecordSetTaxbill("apt_unit") , "" ) & " BOSTON MA "  & RecordSetTaxbill("location_zip_code"))%></td>
		</tr>
...
-->
		<tr class="mainCategoryModuleText">		
			...
			<td align="right"><a href=".?owner=<%=RecordSetTaxbill("owner")%>"><%=RecordSetTaxbill("owner")%></a></td>
		</tr>
		<tr class="mainCategoryModuleText">
...
<tr><td colspan="2" style="vertical-align: top; border-right: solid 1px Gainsboro; padding-right: 2em;">
		<%
		' public disclosure only shown every 3 years
		If TodaysTime >= PublicDisclosureStartOnWeb And TodaysTime <= PublicDisclosureEnd Then Call ShowPublicDisclosure()
		%>
</td></tr>
...
<tr><td width="50%" style="vertical-align: top; border-right: solid 1px Gainsboro; padding-right: 2em;">
	<%
		...
		'If sPropertyType="Condo" Then Call ShowCondoAttributes()
...
<p>Visit <a rel="nofollow" href="/myneighborhood?pid=<%=sParcelID%>">My Neighborhood</a> for information on city services related to this parcel.</p>
...
<div class="black-box">
	<p style="margin:0;">
		<strong>COVID-19 UPDATE 2020-04-07:</strong> The Mayor has extended the deadline for fiscal year 2020 residential and personal exemption applications to June 1, 2020.
	</p>
</div>
<!-- black box -->
...
<b>FY<%=TaxYear%> Public Disclosure period:</b> The triennial public disclosure period for assessed values runs from <%=FormatDateTime(PublicDisclosureStartOfficial,1)%> to <%=FormatDateTime(PublicDisclosureEnd,1)%>.  New assessments are shown in assessing search results.
<br><br>All values are estimated and subject to review and certification by the Massachusetts Department of Revenue.
</font> </div>
<%End If %>
...
<h4>We are trying to make Assessing Online better. Please help us by <a href="https://www.boston.gov/help-us-improve-assessing-online">taking this short survey</a>.</h4>
